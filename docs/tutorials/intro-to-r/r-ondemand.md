...
!!!note Unless the number is an integer, do not use `==` to compare. This is due to the fact that the decimal value may appear the same 
...
!!!note Take note that the spelling needs to be consistent to call the variable correctly.
