...
!!! note
    Before proceeding with the code sections provided below, ensure you replace `/cluster/tufts/workshop/` with the path to your own directory!

## Create the working directory


```
mkdir -p /cluster/tufts/workshop/rnaseq
```
...
```
cd /cluster/tufts/workshop/fetchngs/fetchngsOut/samplesheet
ls
```
...
```
awk -F"," 'OFS=","{print $27,$2,$3,$4}' samplesheet.csv | sed 's/A549_//g' | sed 's/sample_title/sample/g'> /cluster/tufts/workshop/rnaseq/samplesheet.csv
```
...
```
cat /cluster/tufts/workshop/rnaseq/samplesheet.csv
```
...
```
cd /cluster/tufts/workshop/rnaseq/
ln -s /cluster/tufts/workshop/fetchngs/fetchngsOut .
ls -l
```
...
```
ls
  lrwxrwxrwx 1 yzhang85 biotools   69 Mar  1 14:18 fetchngsOut -> /cluster/tufts/workshop/fetchngs/fetchngsOut/
...
- Version: 3.14.0
- Working Directory: `/cluster/tufts/workshop/rnaseq/` ## Change this to your own directory
- outdir: rnaseqOut
...
Core Nextflow options
  ...
  launchDir                 : /cluster/tufts/workshop/rnaseq
  workDir                   : /cluster/tufts/workshop/rnaseq/work
